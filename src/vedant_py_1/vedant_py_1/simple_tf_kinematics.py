...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "my_bot_base"
        self.static_transform_stamped_.child_frame_id = "my_bot_top"
        ...
        self.static_transform_stamped_.transform.rotation.z = 1.0

        

        self.static_tf_broadcaster_.sendTransform(self.static_transform_stamped_)

        self.get_logger().info("publishing static transform_between %s and %s" %
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "my_bot_base"
